...
@section('inside-content')
    ...
    <fieldset class="form-horizontal">
        <form class="m-t js-ajax-form" role="form" action="{{url('admin/system/authority/edit',[$data->id])}}" method="post">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 col-md-6 field">
                    <input type="text" class="form-control input input-big border-left" placeholder="请输入模板名称" name="name" value="{{$data->name}}"
