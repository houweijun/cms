...
@section('inside-content')
    ...
    <fieldset class="form-horizontal">
        <form class="m-t js-ajax-form" role="form" action="{{url('admin/system/parameter/edit',$parameter->id)}}"
              method="post"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 col-md-6 field">
                    ...
                    >@foreach($parameter->options as $key=>$value){{$key.':'}}{{$value.','}}@endforeach</textarea>
                    <div class="tips"></div>
                </div>
