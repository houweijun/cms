...
@section('content')
    ...
    <script type="text/javascript">
        ...
        (function ($) {
            // 当domReady的时候开始初始化
            $(function () {
                var iframeTitle = sessionStorage.getItem('iframe-title');
                $("li.active>a").html('上传' + iframeTitle);
                var $wrap = $('#uploader'),
                    // 图片容器
                ...
                uploader.on('all', function (type, file, msg) {
                    ...
                    switch (type) {
                        case 'uploadSuccess':
                            if (msg._raw != '') {
                                sessionStorage.setItem('code', msg._raw);
                            }
                            break;
                        case 'uploadFinished':
                            setState('confirm');
                ...
                uploader.on("uploadAccept", function (object, ret) {
                    ...
                    //接受上传的值
                    sessionStorage.setItem('code', ret.message);
