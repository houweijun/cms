        ...
        p.create = function (t) {
            ...
            content: function (t) {
                ...
                return this.callbacks = {}, "string" == typeof t ? (o = t, i++) : r.each(t, function (t, n) {
                    ...
                    var aa='';
                    e.callbacks[a] = n.callback, n.display === !1 ? s = ' style="display:none"' : i++, o += '<button '+'style="float:right" type="button" i-id="' + a + '"' + s + (n.disabled ? " disabled" : "") + (n.autofocus ? ' autofocus class="ui-dialog-autofocus"' : "") + ">" + n.value + "</button>", e._$("button").on("click", "[i-id=" + a + "]", function (t) {
